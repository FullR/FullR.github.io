...
var Inequality = _cassowary2["default"].Inequality;
var SimplexSolver = _cassowary2["default"].SimplexSolver;
var Equation = _cassowary2["default"].Equation;
var Expression = _cassowary2["default"].Expression;
var Strength = _cassowary2["default"].Strength;
var LEQ = _cassowary2["default"].LEQ;
var GEQ = _cassowary2["default"].GEQ;
var _c$Strength = _cassowary2["default"].Strength;
var weak = _c$Strength.weak;
var medium = _c$Strength.medium;
var strong = _c$Strength.strong;
var required = _c$Strength.required;
...
function plus(b) {
  return _cassowary2["default"].plus(this, b);
}
function minus(b) {
  return _cassowary2["default"].minus(this, b);
}
function times(b) {
  return _cassowary2["default"].times(this, b);
}
function over(b) {
  return _cassowary2["default"].divide(this, b);
}

var frame = new _rect2["default"]({
  solver: solver,
  topLeft: new _point2["default"](0, 0, "canvas-top-left"),
  width: canvas.width,
...
var homeButton = new _rect2["default"]({
  solver: solver,
  width: 100,
  height: 100,
  style: {
...
var choiceContainer = new _rect2["default"]({
  solver: solver,
  height: 150,
  style: {
    fillStyle: "#00F"
...
var choices = [new _rect2["default"]({ solver: solver,
  style: { fillStyle: color() }
}), new _rect2["default"]({ solver: solver,
  style: { fillStyle: color() }
}), new _rect2["default"]({ solver: solver,
  style: { fillStyle: color() }
})];

var margin = 25; //choiceContainer.width::over(20);
solver.add((_context = homeButton.bottomLeft.x, eq).call(_context, (_context = frame.bottomLeft.x, plus).call(_context, 25)), (_context = homeButton.bottomLeft.y, eq).call(_context, (_context = frame.bottomLeft.y, minus).call(_context, 25)), (_context = choiceContainer.center.x, eq).call(_context, frame.center.x), (_context = choiceContainer.bottomLeft.x, geq).call(_context, homeButton.right.x, weak),
//choiceContainer.bottomRight.x::leq(frame.bottomRight.x::minus(homeButton.right.x), medium),
(_context = choiceContainer.bottomLeft.y, eq).call(_context, (_context = frame.bottom.y, minus).call(_context, 150)));

choices.forEach(function (choice) {
  var _context2;

  solver.add((_context2 = choice.width, eq).call(_context2, (_context2 = (_context2 = choiceContainer.width, minus).call(_context2, times.call(margin, choices.length + 1)), over).call(_context2, choices.length)), (_context2 = choice.height, eq).call(_context2, (_context2 = choiceContainer.height, times).call(_context2, 0.8)), (_context2 = choice.center.y, eq).call(_context2, choiceContainer.center.y));
});

solver.add((_context = choices[0].left.x, eq).call(_context, (_context = choiceContainer.left.x, plus).call(_context, margin)));

choices.reduce(function (prev, cur) {
  var _context3;

  solver.add((_context3 = cur.left.x, eq).call(_context3, (_context3 = prev.right.x, plus).call(_context3, margin)));
  return cur;
});

console.log(_lodash2["default"].invoke(choices, "toString"));
...
window.addEventListener("resize", function (event) {
  ...
  solver.addEditVar(frame.width).addEditVar(frame.height).beginEdit();

  solver.suggestValue(frame.width, width).suggestValue(frame.height, height).resolve();
...
function color() {
  var h = arguments[0] === undefined ? Math.random() * 360 : arguments[0];
...
function rand() {
  var bottom = arguments[0] === undefined ? 0 : arguments[0];
  var top = arguments[1] === undefined ? 100 : arguments[1];
...
function chain(rects, sourceCKey, targetCKey, startPoint) {
  ...
  if (startPoint) {
    ...
    this.add((_context4 = rects[0][sourceCKey].x, eq).call(_context4, startPoint.x), (_context4 = rects[0][sourceCKey].y, eq).call(_context4, startPoint.y));
  }

  rects.reduce(function (prev, rect) {
    var _context5;

    _this2.add((_context5 = rect[sourceCKey].x, eq).call(_context5, prev[targetCKey].x), (_context5 = rect[sourceCKey].y, eq).call(_context5, prev[targetCKey].y));
    return prev;
  });
...
},{"./point":2,"./quad":3,"./rect":4,"cassowary":5,"lodash":6}],2:[function(require,module,exports){
"use strict";
...
var Point = (function () {
  function Point(x, y, label) {
    ...
    this.label = label;
    this.x = new _cassowary.Variable({
      name: "point-" + label + "-x",
      value: x
    });
    this.y = new _cassowary.Variable({
      name: "point-" + label + "-y",
      value: y
    });
  }
...
},{"cassowary":5}],3:[function(require,module,exports){
"use strict";
...
var Expression = _cassowary2["default"].Expression;
var Equation = _cassowary2["default"].Equation;
var Variable = _cassowary2["default"].Variable;
...
function constrainMidPoint(solver, p1, p2, mp) {
  var xExpr = new Expression(p1.x).plus(p2.x).divide(2);
  var yExpr = new Expression(p1.y).plus(p2.y).divide(2);

  solver.addConstraint(new Equation(mp.x, xExpr)).addConstraint(new Equation(mp.y, yExpr));
}
...
var Quad = (function () {
  function Quad() {
    ...
    var topLeft = _ref$topLeft === undefined ? new _point2["default"](0, 0, "top-left") : _ref$topLeft;
    var _ref$topRight = _ref.topRight;
    var topRight = _ref$topRight === undefined ? new _point2["default"](0, 0, "top-right") : _ref$topRight;
    var _ref$bottomLeft = _ref.bottomLeft;
    var bottomLeft = _ref$bottomLeft === undefined ? new _point2["default"](0, 0, "bottom-left") : _ref$bottomLeft;
    var _ref$bottomRight = _ref.bottomRight;
    var bottomRight = _ref$bottomRight === undefined ? new _point2["default"](0, 0, "bottom-right") : _ref$bottomRight;
    ...
    this.top = new _point2["default"](0, 0, "top");
    this.bottom = new _point2["default"](0, 0, "bottom");
    this.left = new _point2["default"](0, 0, "left");
    this.right = new _point2["default"](0, 0, "right");

    this.vCenter = new _point2["default"](0, 0, "v-center");
    this.hCenter = new _point2["default"](0, 0, "h-center");
    this.center = new _point2["default"](0, 0, "center");
  }
  ...
  _createClass(Quad, [{
    ...
    key: "points",
    get: function () {
      return [].concat(_toConsumableArray(this.sides), _toConsumableArray(this.corners));
    }
  }, {
    key: "constrain",
    value: function constrain(solver) {
      var _ref2 = arguments[1] === undefined ? {} : arguments[1];

      var cornerStrength = _ref2.cornerStrength;
      ...
      var vCenter = this.vCenter;
      var hCenter = this.hCenter;
      ...
      solver.addConstraint(new Equation(center.x, hCenter.x)).addConstraint(new Equation(center.y, vCenter.y));

      // keep top corners from passing bottom corners and left corners from passing right corners
      ineqConst(solver, _cassowary2["default"].plus(topLeft.x, 20), LEQ, topRight.x); // (topLeft.x + 20) <= topRight.x
      ineqConst(solver, _cassowary2["default"].plus(topLeft.x, 20), LEQ, bottomRight.x); // (topLeft.x + 20) <= bottomRight.x
      ineqConst(solver, _cassowary2["default"].plus(bottomLeft.x, 20), LEQ, topRight.x); // (bottomLeft.x + 20) <= topRight.x
      ineqConst(solver, _cassowary2["default"].plus(bottomLeft.x, 20), LEQ, bottomRight.x); // (bottomLeft.x + 20) <= bottomRight.x
      ineqConst(solver, _cassowary2["default"].plus(topLeft.y, 20), LEQ, bottomLeft.y); // (topLeft.y + 20) <= bottomLeft.y
      ineqConst(solver, _cassowary2["default"].plus(topLeft.y, 20), LEQ, bottomRight.y); // (topLeft.y + 20) <= bottomRight.y
      ineqConst(solver, _cassowary2["default"].plus(topRight.y, 20), LEQ, bottomLeft.y); // (topRight.y + 20) <= bottomLeft.y
      ineqConst(solver, _cassowary2["default"].plus(topRight.y, 20), LEQ, bottomRight.y); // (topRight.y + 20) <= bottomRight.y
    }
  }, {
    key: "draw",
    value: function draw(context) {
      ...
      var fillStyle = _ref3$fillStyle === undefined ? "#FFF" : _ref3$fillStyle;
      var topLeft = this.topLeft;
      var topRight = this.topRight;
      var bottomLeft = this.bottomLeft;
      var bottomRight = this.bottomRight;
...
},{"./point":2,"cassowary":5}],4:[function(require,module,exports){
"use strict";
...
function maybeCPoint(point) {
  if (point instanceof _point2["default"]) {
    return point;
  } else if (point) return new _point2["default"](point.x, point.y);else return new _point2["default"](0, 0);
}
...
var Rect = (function () {
  function Rect() {
    ...
    var style = _ref$style === undefined ? {
      fillStyle: "#FFF"
    } : _ref$style;
    var weightMap = _ref.weightMap;
    ...
    if (!topLeft && typeof x === "number" && typeof y === "number") {
      this.topLeft = new _point2["default"](x, y);
    } else {
    ...
    this.weightMap = weightMap || _lodash2["default"].transform(arguments[0], function (map, value, key) {
      if (key) {
  ...
  _createClass(Rect, [{
    key: "points",
    get: function () {
      return [this.topLeft, this.topRight, this.bottomLeft, this.bottomRight, this.top, this.bottom, this.left, this.right, this.center];
    }
  }, {
    key: "constrain",
    value: function constrain(solver) {
      ...
      _lodash2["default"].each(weightMap, function (_x2, key) {
        var weight = arguments[0] === undefined ? weak : arguments[0];

        var v = _this[key];
        if (v) {
          if (v instanceof _point2["default"]) {
      ...
      solver
      // top right
      .addConstraint(new Equation(new Expression(topLeft.x).plus(width), topRight.x)).addConstraint(new Equation(topLeft.y, topRight.y))
      // bottom left
      .addConstraint(new Equation(topLeft.x, bottomLeft.x)).addConstraint(new Equation(new Expression(topLeft.y).plus(height), bottomLeft.y))
      // bottom right
      .addConstraint(new Equation(new Expression(topLeft.x).plus(width), bottomRight.x)).addConstraint(new Equation(new Expression(topLeft.y).plus(height), bottomRight.y)).addConstraint(new Equation(new Expression(bottomRight.x).minus(width), topLeft.x)).addConstraint(new Equation(new Expression(bottomRight.y).minus(height), topLeft.y))
      // identities
      .addConstraint(new Equation(topRight.x, bottomRight.x)).addConstraint(new Equation(topLeft.x, bottomLeft.x)).addConstraint(new Equation(bottom.x, top.x)).addConstraint(new Equation(left.y, right.y)).addConstraint(new Equation(topLeft.y, topRight.y)).addConstraint(new Equation(bottomLeft.y, bottomRight.y))

      // top
      .addConstraint(new Equation(new Expression(topLeft.x).plus(topRight.x).divide(2), top.x))
      // bottom
      .addConstraint(new Equation(new Expression(bottomLeft.x).plus(bottomRight.x).divide(2), bottom.x))
      // left
      .addConstraint(new Equation(new Expression(topLeft.y).plus(bottomLeft.y).divide(2), left.y))
      // right
      .addConstraint(new Equation(new Expression(topRight.y).plus(bottomRight.y).divide(2), right.y))
      // center
      .addConstraint(new Equation(top.x, center.x)).addConstraint(new Equation(left.y, center.y)).addConstraint(new Equation(topLeft.x, new Expression(center.x).minus(_cassowary2["default"].divide(width, 2)))).addConstraint(new Equation(topLeft.y, new Expression(center.y).minus(_cassowary2["default"].divide(height, 2)))).addConstraint(new Equation(width, new Expression(right.x).minus(left.x))).addConstraint(new Equation(height, new Expression(bottom.y).minus(top.y))).addConstraint(new Equation(width, new Expression(center.x).minus(left.x).times(2))).addConstraint(new Equation(width, new Expression(right.x).minus(center.x).times(2))).addConstraint(new Equation(height, new Expression(center.y).minus(top.y).times(2))).addConstraint(new Equation(height, new Expression(bottom.y).minus(center.y).times(2)));
...
},{"./point":2,"cassowary":5,"lodash":6}],5:[function(require,module,exports){
/**
